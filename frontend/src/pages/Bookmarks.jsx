...
const Bookmarks = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h2 className="font-inter font-bold text-3xl mb-10 text-center tracking-tight bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent">
        Saved Posts
      </h2>
...
"You haven’t saved anything yet. Find something you like and bookmark it for later."          </div>
        ) : (
          <div className="space-y-6">
            {bookmarks.map(post => (
              <PostCard 
