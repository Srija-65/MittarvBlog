...
const Home = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="font-inter font-bold text-3xl mb-10 text-center tracking-tight bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent">
         Your Feed
     </div>
