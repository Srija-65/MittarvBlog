            ...
            {tagArray.length > 0 && (
              <div className="flex flex-wrap gap-2 mb-6">
                {tagArray.map(tag => (
                  <span 
                    key={tag}
                    className="bg-gradient-to-r from-teal-400 to-emerald-500 text-white px-2 py-0.5 rounded-full text-xs font-medium shadow-md hover:from-teal-500 hover:to-emerald-600 transition">
                    #{tag}
                  </span>
                ))}
              </div>
